...
enum class PIN : GPIO_REGISTER_WIDTH {
		P0  = (1U << 0U),
		P1  = (1U << 1U),
		P2  = (1U << 2U),
		P3  = (1U << 3U),
	...
	namespace MSP430 {
		namespace GPIO {
			namespace Internal {
				...
				template <volatile auto * INREG, volatile auto * OUTREG,volatile auto * DIRREG,
				volatile auto * PRENREG, volatile auto * P0SEL, volatile auto * P1SEL,
				volatile auto * IESREG , volatile auto * IEREG , volatile auto * IFGREG  >
				class PortWithInt {
